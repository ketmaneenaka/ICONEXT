#pragma checksum "C:\Users\Prae_Nicha\Source\Repos\ICONEXT_Project-management\ICONEXT\Views\Home\Holiday.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "56d4f1bb3704d3f93e84da8525867fbca1955478"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"56d4f1bb3704d3f93e84da8525867fbca1955478", @"/Views/Home/Holiday.cshtml")]
    ...
    public class Views_Home_Holiday : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "C:\Users\Prae_Nicha\Source\Repos\ICONEXT_Project-management\ICONEXT\Views\Home\Holiday.cshtml"
...
");
    ...
    .event {
        ...
        .event.begin {
            ...
            borde");
            WriteLiteral(@"r-bottom-left-radius: 4px;
        }
...
<script type=""text/tmpl"" id=""tmpl"">
 ...
 ");
            WriteLiteral(@"     startingDay = first.getDay(),
                    ...
                    <table style=""white-space: nowrap; width: 100%"">
                        <tr>
                            <td style=""text-align: left;"">
                                ...
                                <button class=""js-cal-option btn btn-default {{: first.toDateInt() <= today.toDateInt() && today.toDateIn");
            WriteLiteral(@"t() <= last.toDateInt() ? 'active':'' }}"" data-date=""{{: today.toISOString()}}"" data-mode=""month"">{{: todayname }}</button>
                            </td>

                            <td style=""text-align: left;"">
                                <a href=""AddHoliday"" class=""btn btn-primary"">Import CSV</a>
                            </td>
                            ...
                            <td>
                                <span class=""btn-group btn-group-lg"">
                                    ...
                                    {{ if (mode !== 'day') { }}
                                    {{ if (mode === 'month') { }}<a class=""js-cal-option btn btn-link"" data-mode=""year"">{{: months[month] }}</a>{{ } }}
                                    {{ if (mode ==='week') { }}

                                    <a class=""btn btn-link disabled"">{{: shortMonths[first.getMonth()] }} {{: first.getDate() }} - {{: shortMonths[last.getMonth()");
            WriteLiteral(@"] }} {{: last.getDate() }}</a>
                                    {{ } }}
                                    <a class=""js-cal-years btn btn-link"">{{: year}}</a>
...
//the design is a function I read in a blog post by John Resig (http://ejohn.org/blog/javascript-micro-templating/) and it is intended to be loosely translateable to a more comprehensive template language like must");
            WriteLiteral(@"ache easily
$.extend({
...
(function ($) {
  ...
  function calendar($el, options) {
    ...
    $el.on('click', '.js-cal-prev', function () {
      ...
      $t.popover({co");
            WriteLiteral(@"ntent: s, html: true, placement: 'auto top'}).popover('toggle');
      return false;
    ...
    function monthAddEvent(index, event) {
      var $event = $('<div/>', {'class': 'event', text: event.title, title: event.title, 'data-index': index}),
          ...
          empty = $('<div");
            WriteLiteral(@"/>', {'class':'clear event', html:' '}),
          numbevents = 0,
      ...
      while (e <= event.end && (day.length || endday || options.date < checkanyway)) {
        if(day.length) {
          ...
          day.append(
            $event.
            toggleClass('beg");
            WriteLiteral(@"in', dateclass === event.start.toDateCssClass()).
    ...
    function draw() {
      ...
      $('.' + (new Date()");
            WriteLiteral(@").toDateCssClass()).addClass('today');
...
var data = [],
   ...
   // names = ['All Day Event', 'Long Event', 'Birthday Party', 'Repeating Event', 'Training', 'Meeting', 'Mr. Behnke', 'Date', 'Ms. Tubbs'],
    slipsum = [""Now that we know who you are, I know who I am. I'm not a mistake! It all makes sense! In a comic, you know how you can tell who the arch-villain's going to be? He's the exact opposite of th");
            WriteLiteral(@"e hero. And most times they're friends, like you and me! I should've known way back when... You know why, David? Because of the kids. They called me Mr Glass."", ""You see? It's curious. Ted did figure it out - time travel. And when we get back, we gonna tell everyone. How it's possible, how it's done, what the dangers are. But then why fifty years in the future when the spacecraft encounters a black hole does the computer call it an 'unknown entry event'? Why don't they know? If they don't know, that means we never told anyone. And if we never told anyone it means we never made it back. Hence we die down here. Just as a matter of deductive logic."", ""Your bones don't break, mine do. That's clear. Your cells react to bacteria and viruses differently than mine. You don't get sick, I do. That's also clear. But for some reason, you and I react the exact same way to water. We swallow it too fast, we choke. We get some in our lungs, we drown. However unreal it may seem, we are connected, you and I. We're on the same ");
            WriteLiteral(@"curve, just on opposite ends."", ""Well, the way they make shows is, they make one show. That show's called a pilot. Then they show that show to the people who make shows, and on the strength of that one show they decide if they're going to make more shows. Some pilots get picked and become television programs. Some don't, become nothing. She starred in one of the ones that became nothing."", ""Yeah, I like animals better than people sometimes... Especially dogs. Dogs are the best. Every time you come home, they act like they haven't seen you in a year. And the good thing about dogs... is they got different dogs for different people. Like pit bulls. The dog of dogs. Pit bull can be the right man's best friend... or the wrong man's worst enemy. You going to give me a dog for a pet, give me a pit bull. Give me... Raoul. Right, Omar? Give me Raoul."", ""Like you, I used to think the world was this great place where everybody lived by the same standards I did, then some kid with a nail showed me I was living in his wor");
            WriteLiteral(@"ld, a world where chaos rules not order, a world where righteousness is not rewarded. That's Cesar's world, and if you're not willing to play by his rules, then you're gonna have to pay the price."", ""You think water moves fast? You should see ice. It moves like it has a mind. Like it knows it killed the world once and got a taste for murder. After the avalanche, it took us a week to climb out. Now, I don't know exactly when we turned on each other, but I know that seven of us survived the slide... and only five made it out. Now we took an oath, that I'm breaking now. We said we'd say it was the snow that killed the other two, but it wasn't. Nature is lethal but it doesn't hold a candle to man."", ""You see? It's curious. Ted did figure it out - time travel. And when we get back, we gonna tell everyone. How it's possible, how it's done, what the dangers are. But then why fifty years in the future when the spacecraft encounters a black hole does the computer call it an 'unknown entry event'? Why don't they know? ");
            WriteLiteral(@"If they don't know, that means we never told anyone. And if we never told anyone it means we never made it back. Hence we die down here. Just as a matter of deductive logic."", ""Like you, I used to think the world was this great place where everybody lived by the same standards I did, then some kid with a nail showed me I was living in his world, a world where chaos rules not order, a world where righteousness is not rewarded. That's Cesar's world, and if you're not willing to play by his rules, then you're gonna have to pay the price."", ""You think water moves fast? You should see ice. It moves like it has a mind. Like it knows it killed the world once and got a taste for murder. After the avalanche, it took us a week to climb out. Now, I don't know exactly when we turned on each other, but I know that seven of us survived the slide... and only five made it out. Now we took an oath, that I'm breaking now. We said we'd say it was the snow that killed the other two, but it wasn't. Nature is lethal but it doesn't");
            WriteLiteral(@" hold a candle to man.""];
